...
/**
 * Class CreateStockPlacementApiRequest
 *
 */
class CreateStockPlacementApiRequest extends ApiRequest
{
    /**
    ...
    /**
     * Prepare the attribute stock_movement_type_id with the Id of the placement type of stock movement.
     *
     * @return array
     */
    protected function getStockMovementType(): array
    {
        return ['stock_movement_type_id' => config('stock.fk_placed')];
    }
